        ...
        for epoch in range(max_epochs): 
            ...
            if epoch == max_epochs-1: 
                ...
                for ii in range(iters):
                    ...
                    f_out = model(inputs)[0]
                    ewc_loss = dcc_loss_ewc(f_out, labels)
                    ewc_loss.backward()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--icm', type=bool, default=True)
    parser.add_argument('--end-cm', type=bool, default=True)
